...
print("Score sur les données d'entraînement: {:.3f}".format(model.score(learningFeatures_scaled, learningLabelsStd)))
print("Score sur les données de test: {:.3f}".format(model.score(testFeatures_scaled, testLabelsStd)))