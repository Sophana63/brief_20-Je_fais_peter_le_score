...
print("Xtrain = ", np.shape(learningFeatures_scaled))
print("Xtest = ",np.shape(X_test))
print("ytrain = ",np.shape(learningLabelsStd))
print("ytest = ",np.shape(testLabelsStd))

with open('Data/train_test_0.2_0.2s.pickle', 'wb') as handle:
